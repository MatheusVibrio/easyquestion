    ...
    <div>
      <form className="flex-column" onSubmit={handleSubmit}>
        ...
        <div className="flex justify-end space-x-2 mb-3">
          <button
            type="submit"
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center my-1 text-xs"
          >
            Buscar
          </button>
          <button
            type="button"
            onClick={handleClear}
            className="text-white bg-gray-500 hover:bg-gray-600 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center my-1 text-xs"
          >
            Limpar
          </button>
        </div>
