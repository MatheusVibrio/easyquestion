...
const CriarProvaCoordenador = () => {
  ...
  const handleCriarQuestao = async (event: any) => {
    ...
    try {
      ...
      if (user?.fk_id_tipo && (user.fk_id_tipo.id_tipo === 2 || user.fk_id_tipo.id_tipo === 3)) {
        navigate("/coordenador/provas");
      } else {
        navigate("/provas");
      }
...
export default CriarProvaCoordenador;
